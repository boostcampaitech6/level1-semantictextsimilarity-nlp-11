...
if __name__ == '__main__':
    ...
    sweep_config = {
        'method': 'grid', # random: 임의의 값의 parameter 세트를 선택
        'parameters': {
            'lr':{
                'values': [6e-5]
            },
    ...
    def sweep_train(config=None):
        ...
        wandb_logger = WandbLogger(name='nlp-11', project="lev1_lr_monologg", entity="nlp-11_4intcute")

        trainer = pl.Trainer(max_epochs=config.epoch, logger=wandb_logger, log_every_n_steps=1, 
                             callbacks=[
    ...
    sweep_id = wandb.sweep(
        ...
        project='lev1_lr_monologg',  # project의 이름을 추가합니다.
        entity="nlp-11_4intcute"
    )
