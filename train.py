...
# parser.add_argument('--model_name', default='monologg/kobert', type=str)
# parser.add_argument('--model_name', default='kykim/bert-kor-base', type=str)
# parser.add_argument('--model_name', default='kykim/funnel-kor-base', type=str)
# parser.add_argument('--model_name', default='kykim/electra-kor-base', type=str)
# parser.add_argument('--model_name', default='snulp/KR-ELECTRA', type=str)
